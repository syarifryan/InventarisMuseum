...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('app-assets/css/select2/select2.css')); ?>">

    <?php echo $__env->yieldContent('css'); ?>

    <title><?php echo $__env->yieldContent('title', 'Inventaris Koleksi'); ?></title>
</head>
...
<body>
            ...
            <div class="hp-sidebar-container">
                <div class="hp-sidebar-header-menu">
                    <div class="row justify-content-between align-items-end me-12 ms-24 mt-24">
                        ...
                        <?php echo $__env->make('partials.dashboard.logo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.dashboard.custom-theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('app-assets/js/plugin/apex-chart.js')); ?>"></script>
    <script src="<?php echo e(asset('app-assets/js/plugin/apexcharts.min.js')); ?>"></script>
    ...
    <!-- Charts -->
    <script src="<?php echo e(asset('app-assets/js/charts/apex-chart.js')); ?>"></script>
    <script src="<?php echo e(asset('app-assets/js/charts/apex-chart.min.js')); ?>"></script>
    ...
    <!-- PHP JS -->
    <script src="<?php echo e(asset('app-assets/js/phpjs/variable.min.js')); ?>"></script>

    <!-- Select2 -->
    <script src="<?php echo e(asset('app-assets/js/select2/select2.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\Inventaris\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>